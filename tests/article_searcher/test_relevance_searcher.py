...
from src.article_searcher.relevance_searcher import RelevanceSearcher


class RelevanceSearcherTests(unittest.TestCase):
    def test_parse_urls_from_search_results(self):
        ...
        # When
        urls = RelevanceSearcher._get_article_urls_from_relevance_results_page(search_result)
        # Then
        self.assertEqual(
            [
    ...
    def test_get_urls_from_search_term_for_just_10_results(self, mock):
        ...
        article_searcher = RelevanceSearcher(search_term="mySearchTerm")
        # When
        urls = article_searcher.get_next_batch()
        # Then
    ...
    def test_get_urls_from_search_term_for_multiple_results(self, mock):
        ...
        article_searcher = RelevanceSearcher(search_term="mySearchTerm")
        # When
        urls = article_searcher.get_next_batches(num_batches=4)
        # Then
    ...
    def test_raise_runtime_error_if_http_response_is_different_from_200(self, mock):
        ...
        self.assertRaises(
            RuntimeError,
            article_searcher.get_next_batch,
        )
